	...
	<div class="membership-content-wrapper">
		<div class="container clear">
			<div id="choose-membership" class="tab-content active">
				...
				<?php echo $centirePlans->getPlansHTML('main'); ?>
			</div>
				...
				<div class="additions-block">
					<div class="clear">
						<div class="additions-col">
							<img class="additions-icon" alt="" src="<?php echo get_theme_file_uri('assets/images/additions-icon-blue-1.png'); ?>" srcset="<?php echo get_theme_file_uri('assets/images/additions-icon-blue-1.png'); ?> 1x, <?php echo get_theme_file_uri('assets/images/additions-icon-blue-1_2x.png'); ?> 2x" />
							<h3>Unlimited Creche</h3>
							<p>$5 per week</p>
							<a href="#"><span><img alt="" src="<?php echo get_theme_file_uri('assets/images/white-tick.png'); ?>" srcset="<?php echo get_theme_file_uri('assets/images/white-tick.png'); ?> 1x, <?php echo get_theme_file_uri('assets/images/white-tick_2x.png'); ?> 2x" /></span>ADDED</a>
						</div>
						<div class="additions-col">
							<img class="additions-icon" alt="" src="<?php echo get_theme_file_uri('assets/images/additions-icon-blue-3.png'); ?>" srcset="<?php echo get_theme_file_uri('assets/images/additions-icon-blue-3.png'); ?> 1x, <?php echo get_theme_file_uri('assets/images/additions-icon-blue-3_2x.png'); ?> 2x" />
			...
			<div id="personal-detail" class="tab-content">
				<div class="personal-detail-block clear">
					<div class="personal-col-left">
						...
						<a href="#" class="facebook-btn"><img alt="" src="<?php echo get_theme_file_uri('assets/images/facebook-btn.png'); ?>" srcset="<?php echo get_theme_file_uri('assets/images/facebook-btn.png'); ?> 1x, <?php echo get_theme_file_uri('assets/images/facebook-btn_2x.png'); ?> 2x" /></a>
			...
			<div id="confirmation" class="tab-content">
				<div class="confirmation-block">
					<img class="user-image" alt="" src="<?php echo get_theme_file_uri('assets/images/trav.jpg'); ?>" srcset="<?php echo get_theme_file_uri('assets/images/trav.jpg'); ?> 1x, <?php echo get_theme_file_uri('assets/images/trav_2x.jpg'); ?> 2x" />
				...
				<div class="confirmation-thanks-wrapper">
					<div class="thanks-block">
						...
						<div class="thanks-contact clear">
							<div class="thanks-icon"><img alt="" src="<?php echo get_theme_file_uri('assets/images/phone-icon-blue.png'); ?>" /></div>
							<div>(07) 3898 1992</div>
							<div class="thanks-icon mail-icon"><img alt="" src="<?php echo get_theme_file_uri('assets/images/mail-icon-blue.png'); ?>" /></div>
